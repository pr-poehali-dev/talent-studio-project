  ...
  return (
    <div className="container mx-auto px-[40px] py-12">
      ...
      <section className="text-center mb-16 animate-in fade-in duration-700">
        <h1 className="text-5xl md:text-7xl font-heading mb-6 font-bold italic" style={{ color: '#E31E24' }}>Мечтай, твори, дерзай!</h1>
        ...
        <div className="max-w-4xl mx-auto mb-4 flex items-center gap-6 bg-white border-l-8 border-primary rounded-2xl shadow-md px-10 py-6 text-left">
        ...
        <div className="max-w-4xl mx-auto mb-8 flex items-center gap-6 bg-white border-l-8 border-primary rounded-2xl shadow-md px-10 py-6 text-left">
          ...
          <p className="text-xl text-slate-700 font-medium leading-relaxed">
            Бесплатное участие для детей с ОВЗ и детей участников СВО. Отправьте на электронную почту{" "}
            <a href="mailto:studio-talantov@yandex.ru" className="text-primary underline decoration-2 underline-offset-4 hover:opacity-80 transition-opacity">studio-talantov@yandex.ru</a>
            : фото работы,{" "}
            {applicationFormUrl ? (
              <a href={applicationFormUrl} target="_blank" rel="noopener noreferrer" className="text-primary underline decoration-2 underline-offset-4 hover:opacity-80 transition-opacity">лист подачи заявки</a>
            ) : (
              "лист подачи заявки"
            )}
            {" "}в электронном формате Microsoft Word и отсканированный подтверждающий документ (справка или удостоверение)
          </p>
        </div>
